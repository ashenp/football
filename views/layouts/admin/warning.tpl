...
#messageBox .messageContent{background:url(/static/images/warning.gif) no-repeat 40px 35px; height:150px;}
#messageBox .messageInfo{margin-left:120px; margin-top:40px; float:left; font-size:14px;  height:80px;}
</style>
{/literal}
		<div id="messageBox">
		<div class="messageTitle">操作提示</div>
